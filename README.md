# CDKTF Go bindings for integrations/github provider version 6.11.0
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-github/blob/main/docs/API.go.md).
