...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/data-sources/team github_team}.
...
func (j *jsiiProxy_DataGithubTeam) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataGithubTeam) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataGithubTeam) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGithubTeam) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataGithubTeam) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/data-sources/team github_team} Data Source.
...
func (j *jsiiProxy_DataGithubTeam)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGithubTeam)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGithubTeam)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (d *jsiiProxy_DataGithubTeam) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGithubTeam) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
