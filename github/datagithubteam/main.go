...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "repositoriesDetailed", GoGetter: "RepositoriesDetailed"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMembershipType", GoMethod: "ResetMembershipType"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetResultsPerPage", GoMethod: "ResetResultsPerPage"},
			_jsii_.MemberMethod{JsiiMethod: "resetSummaryOnly", GoMethod: "ResetSummaryOnly"},
			_jsii_.MemberProperty{JsiiProperty: "resultsPerPage", GoGetter: "ResultsPerPage"},
			_jsii_.MemberProperty{JsiiProperty: "resultsPerPageInput", GoGetter: "ResultsPerPageInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.dataGithubTeam.DataGithubTeamConfig",
		reflect.TypeOf((*DataGithubTeamConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.dataGithubTeam.DataGithubTeamRepositoriesDetailed",
		reflect.TypeOf((*DataGithubTeamRepositoriesDetailed)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-github.dataGithubTeam.DataGithubTeamRepositoriesDetailedList",
		reflect.TypeOf((*DataGithubTeamRepositoriesDetailedList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGithubTeamRepositoriesDetailedOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
