...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGithubOrganizationCustomProperties)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetValuesEditableBy", GoMethod: "ResetValuesEditableBy"},
			...
			_jsii_.MemberProperty{JsiiProperty: "valuesEditableBy", GoGetter: "ValuesEditableBy"},
			_jsii_.MemberProperty{JsiiProperty: "valuesEditableByInput", GoGetter: "ValuesEditableByInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.dataGithubOrganizationCustomProperties.DataGithubOrganizationCustomPropertiesConfig",
		reflect.TypeOf((*DataGithubOrganizationCustomPropertiesConfig)(nil)).Elem(),
	)
}
