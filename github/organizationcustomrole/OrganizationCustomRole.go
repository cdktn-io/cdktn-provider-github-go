...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v15/organizationcustomrole/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/organization_custom_role github_organization_custom_role}.
...
func (j *jsiiProxy_OrganizationCustomRole) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_OrganizationCustomRole) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OrganizationCustomRole) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrganizationCustomRole) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_OrganizationCustomRole) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/organization_custom_role github_organization_custom_role} Resource.
...
func (j *jsiiProxy_OrganizationCustomRole)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrganizationCustomRole)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrganizationCustomRole)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OrganizationCustomRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationCustomRole) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationCustomRole) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationCustomRole) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
