...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/repository_pull_request github_repository_pull_request}.
...
func (j *jsiiProxy_DataGithubRepositoryPullRequest) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/repository_pull_request github_repository_pull_request} Data Source.
func NewDataGithubRepositoryPullRequest(scope constructs.Construct, id *string, config *DataGithubRepositoryPullRequestConfig) DataGithubRepositoryPullRequest {
	...
	if err := validateNewDataGithubRepositoryPullRequestParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataGithubRepositoryPullRequest)SetCount(val interface{}) {
...
func DataGithubRepositoryPullRequest_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGithubRepositoryPullRequest_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGithubRepositoryPullRequest_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGithubRepositoryPullRequest_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGithubRepositoryPullRequest_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGithubRepositoryPullRequest_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGithubRepositoryPullRequest_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGithubRepositoryPullRequest_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGithubRepositoryPullRequest) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGithubRepositoryPullRequest) ToHclTerraform() interface{} {
	var returns interface{}
