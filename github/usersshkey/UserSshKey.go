...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/user_ssh_key github_user_ssh_key}.
...
func (j *jsiiProxy_UserSshKey) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_UserSshKey) Url() *string {
	var returns *string
	_jsii_.Get(
		j,
		"url",
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/user_ssh_key github_user_ssh_key} Resource.
