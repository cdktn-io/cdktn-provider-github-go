...
func validateDataGithubApp_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGithubApp) validateSetCountParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_DataGithubApp) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}
