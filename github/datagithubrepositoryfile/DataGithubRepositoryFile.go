...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/datagithubrepositoryfile/internal"
...
func (j *jsiiProxy_DataGithubRepositoryFile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGithubRepositoryFile) Count() interface{} {
...
func (j *jsiiProxy_DataGithubRepositoryFile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGithubRepositoryFile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGithubRepositoryFile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGithubRepositoryFile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/repository_file github_repository_file} Data Source.
func NewDataGithubRepositoryFile(scope constructs.Construct, id *string, config *DataGithubRepositoryFileConfig) DataGithubRepositoryFile {
	...
	if err := validateNewDataGithubRepositoryFileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataGithubRepositoryFile)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGithubRepositoryFile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGithubRepositoryFile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGithubRepositoryFile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGithubRepositoryFile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataGithubRepositoryFile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGithubRepositoryFile_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGithubRepositoryFile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGithubRepositoryFile_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGithubRepositoryFile_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGithubRepositoryFile_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGithubRepositoryFile_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGithubRepositoryFile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubRepositoryFile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubRepositoryFile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGithubRepositoryFile) ToHclTerraform() interface{} {
	var returns interface{}
