...
func (j *jsiiProxy_RepositoryCollaborators) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RepositoryCollaborators) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RepositoryCollaborators) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RepositoryCollaborators) InvitationIds() cdktn.StringMap {
...
func (j *jsiiProxy_RepositoryCollaborators) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RepositoryCollaborators) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RepositoryCollaborators) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_collaborators github_repository_collaborators} Resource.
...
func (j *jsiiProxy_RepositoryCollaborators)SetCount(val interface{}) {
...
func (j *jsiiProxy_RepositoryCollaborators)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RepositoryCollaborators)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RepositoryCollaborators)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RepositoryCollaborators_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRepositoryCollaborators_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RepositoryCollaborators) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RepositoryCollaborators) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RepositoryCollaborators) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RepositoryCollaborators) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RepositoryCollaborators) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RepositoryCollaborators) ToHclTerraform() interface{} {
	var returns interface{}
