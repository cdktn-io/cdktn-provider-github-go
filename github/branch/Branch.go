...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/branch/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/branch github_branch}.
...
func (j *jsiiProxy_Branch) Branch() *string {
	var returns *string
	_jsii_.Get(
		j,
		"branch",
...
func (j *jsiiProxy_Branch) BranchInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"branchInput",
...
func (j *jsiiProxy_Branch) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Branch) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_Branch) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Branch) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Branch) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Branch) Repository() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repository",
...
func (j *jsiiProxy_Branch) RepositoryInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryInput",
...
func (j *jsiiProxy_Branch) Sha() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sha",
...
func (j *jsiiProxy_Branch) SourceBranch() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceBranch",
...
func (j *jsiiProxy_Branch) SourceBranchInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceBranchInput",
...
func (j *jsiiProxy_Branch) SourceSha() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceSha",
...
func (j *jsiiProxy_Branch) SourceShaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceShaInput",
...
func (j *jsiiProxy_Branch) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/branch github_branch} Resource.
...
func (j *jsiiProxy_Branch)SetBranch(val *string) {
...
func (j *jsiiProxy_Branch)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Branch)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Branch)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Branch)SetRepository(val *string) {
...
func (j *jsiiProxy_Branch)SetSourceBranch(val *string) {
...
func (j *jsiiProxy_Branch)SetSourceSha(val *string) {
	if err := j.validateSetSourceShaParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func Branch_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_Branch) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_Branch) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_Branch) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_Branch) ResetSourceBranch() {
	_jsii_.InvokeVoid(
		b,
		"resetSourceBranch",
		nil, // no parameters
...
func (b *jsiiProxy_Branch) ResetSourceSha() {
	_jsii_.InvokeVoid(
		b,
		"resetSourceSha",
		nil, // no parameters
