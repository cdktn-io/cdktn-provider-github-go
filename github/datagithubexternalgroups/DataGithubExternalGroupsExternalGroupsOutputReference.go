...
func (j *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubExternalGroupsExternalGroupsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGithubExternalGroupsExternalGroupsOutputReference {
	_init_.Initialize()

	if err := validateNewDataGithubExternalGroupsExternalGroupsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataGithubExternalGroupsExternalGroupsOutputReference_Override(d DataGithubExternalGroupsExternalGroupsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
