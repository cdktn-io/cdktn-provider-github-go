...
func (d *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGithubExternalGroupsExternalGroupsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
