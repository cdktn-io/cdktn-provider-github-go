...
type RepositoryFileConfig struct {
	...
	// The file's content.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#content RepositoryFile#content}
	Content *string `field:"required" json:"content" yaml:"content"`
	// The file path to manage.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#file RepositoryFile#file}
	File *string `field:"required" json:"file" yaml:"file"`
	// The repository name.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#repository RepositoryFile#repository}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#autocreate_branch_source_branch RepositoryFile#autocreate_branch_source_branch}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#autocreate_branch_source_sha RepositoryFile#autocreate_branch_source_sha}
	AutocreateBranchSourceSha *string `field:"optional" json:"autocreateBranchSourceSha" yaml:"autocreateBranchSourceSha"`
	// The branch name, defaults to the repository's default branch.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#branch RepositoryFile#branch}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#commit_author RepositoryFile#commit_author}
	...
	// GitHub app users may omit author and email information so GitHub can verify commits as the GitHub App.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#commit_email RepositoryFile#commit_email}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#commit_message RepositoryFile#commit_message}
	CommitMessage *string `field:"optional" json:"commitMessage" yaml:"commitMessage"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_file#id RepositoryFile#id}.
	//
