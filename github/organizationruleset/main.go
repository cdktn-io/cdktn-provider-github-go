...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRefName", GoMethod: "ResetRefName"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.organizationRuleset.OrganizationRulesetRulesCopilotCodeReview",
		reflect.TypeOf((*OrganizationRulesetRulesCopilotCodeReview)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-github.organizationRuleset.OrganizationRulesetRulesCopilotCodeReviewOutputReference",
		reflect.TypeOf((*OrganizationRulesetRulesCopilotCodeReviewOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.organizationRuleset.OrganizationRulesetRulesPullRequestRequiredReviewers",
		reflect.TypeOf((*OrganizationRulesetRulesPullRequestRequiredReviewers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-github.organizationRuleset.OrganizationRulesetRulesPullRequestRequiredReviewersList",
		reflect.TypeOf((*OrganizationRulesetRulesPullRequestRequiredReviewersList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationRulesetRulesPullRequestRequiredReviewersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.organizationRuleset.OrganizationRulesetRulesPullRequestRequiredReviewersReviewer",
		reflect.TypeOf((*OrganizationRulesetRulesPullRequestRequiredReviewersReviewer)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-github.organizationRuleset.OrganizationRulesetRulesPullRequestRequiredReviewersReviewerOutputReference",
		reflect.TypeOf((*OrganizationRulesetRulesPullRequestRequiredReviewersReviewerOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
