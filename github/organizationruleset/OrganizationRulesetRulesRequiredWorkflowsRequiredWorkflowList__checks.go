...
func (o *jsiiProxy_OrganizationRulesetRulesRequiredWorkflowsRequiredWorkflowList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_OrganizationRulesetRulesRequiredWorkflowsRequiredWorkflowList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewOrganizationRulesetRulesRequiredWorkflowsRequiredWorkflowListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
