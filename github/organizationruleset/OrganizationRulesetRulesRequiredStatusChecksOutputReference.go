...
func (o *jsiiProxy_OrganizationRulesetRulesRequiredStatusChecksOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationRulesetRulesRequiredStatusChecksOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
