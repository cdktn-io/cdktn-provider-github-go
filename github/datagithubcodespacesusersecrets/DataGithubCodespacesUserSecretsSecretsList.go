...
func (d *jsiiProxy_DataGithubCodespacesUserSecretsSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubCodespacesUserSecretsSecretsList) Resolve(context cdktf.IResolveContext) interface{} {
