...
func (j *jsiiProxy_DataGithubCodespacesUserSecretsSecretsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubCodespacesUserSecretsSecretsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubCodespacesUserSecretsSecretsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-github.dataGithubCodespacesUserSecrets.DataGithubCodespacesUserSecretsSecretsList",
...
func NewDataGithubCodespacesUserSecretsSecretsList_Override(d DataGithubCodespacesUserSecretsSecretsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubCodespacesUserSecretsSecretsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubCodespacesUserSecretsSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubCodespacesUserSecretsSecretsList) Resolve(context cdktn.IResolveContext) interface{} {
