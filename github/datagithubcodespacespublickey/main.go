...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGithubCodespacesPublicKey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.dataGithubCodespacesPublicKey.DataGithubCodespacesPublicKeyConfig",
		reflect.TypeOf((*DataGithubCodespacesPublicKeyConfig)(nil)).Elem(),
	)
}
