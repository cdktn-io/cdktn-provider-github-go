...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v15/teammembership/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/team_membership github_team_membership}.
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/team_membership github_team_membership} Resource.
...
func TeamMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TeamMembership) ImportFrom(id *string, provider cdktf.TerraformProvider) {
