...
func (j *jsiiProxy_DataGithubActionsOrganizationSecretsSecretsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubActionsOrganizationSecretsSecretsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubActionsOrganizationSecretsSecretsList {
	_init_.Initialize()
...
func NewDataGithubActionsOrganizationSecretsSecretsList_Override(d DataGithubActionsOrganizationSecretsSecretsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubActionsOrganizationSecretsSecretsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubActionsOrganizationSecretsSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubActionsOrganizationSecretsSecretsList) Resolve(context cdktn.IResolveContext) interface{} {
