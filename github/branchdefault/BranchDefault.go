...
func (j *jsiiProxy_BranchDefault) BranchInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"branchInput",
...
func (j *jsiiProxy_BranchDefault) Connection() interface{} {
...
func (j *jsiiProxy_BranchDefault) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_BranchDefault) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_BranchDefault) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_BranchDefault) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BranchDefault) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_BranchDefault) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_BranchDefault) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BranchDefault) Node() constructs.Node {
...
func (j *jsiiProxy_BranchDefault) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_BranchDefault) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_BranchDefault) RepositoryInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryInput",
...
func (j *jsiiProxy_BranchDefault) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BranchDefault) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/branch_default github_branch_default} Resource.
func NewBranchDefault(scope constructs.Construct, id *string, config *BranchDefaultConfig) BranchDefault {
	_init_.Initialize()

	if err := validateNewBranchDefaultParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BranchDefault)SetBranch(val *string) {
...
func (j *jsiiProxy_BranchDefault)SetConnection(val interface{}) {
...
func (j *jsiiProxy_BranchDefault)SetCount(val interface{}) {
...
func (j *jsiiProxy_BranchDefault)SetDependsOn(val *[]*string) {
	_jsii_.Set(
		j,
		"dependsOn",
		val,
...
func (j *jsiiProxy_BranchDefault)SetId(val *string) {
...
func (j *jsiiProxy_BranchDefault)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_BranchDefault)SetRepository(val *string) {
...
func BranchDefault_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBranchDefault_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func BranchDefault_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-github.branchDefault.BranchDefault",
...
func (b *jsiiProxy_BranchDefault) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BranchDefault) AddOverride(path *string, value interface{}) {
...
func (b *jsiiProxy_BranchDefault) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (b *jsiiProxy_BranchDefault) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BranchDefault) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BranchDefault) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BranchDefault) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BranchDefault) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BranchDefault) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BranchDefault) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BranchDefault) OverrideLogicalId(newLogicalId *string) {
...
func (b *jsiiProxy_BranchDefault) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BranchDefault) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		b,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (b *jsiiProxy_BranchDefault) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BranchDefault) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BranchDefault) ToHclTerraform() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BranchDefault) ToMetadata() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BranchDefault) ToString() *string {
	var returns *string
...
func (b *jsiiProxy_BranchDefault) ToTerraform() interface{} {
	var returns interface{}
