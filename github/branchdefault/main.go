...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rename", GoGetter: "Rename"},
			_jsii_.MemberProperty{JsiiProperty: "renameInput", GoGetter: "RenameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRename", GoMethod: "ResetRename"},
