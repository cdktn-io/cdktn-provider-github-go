...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "canAdminsBypass", GoGetter: "CanAdminsBypass"},
			_jsii_.MemberProperty{JsiiProperty: "canAdminsBypassInput", GoGetter: "CanAdminsBypassInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "preventSelfReview", GoGetter: "PreventSelfReview"},
			_jsii_.MemberProperty{JsiiProperty: "preventSelfReviewInput", GoGetter: "PreventSelfReviewInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCanAdminsBypass", GoMethod: "ResetCanAdminsBypass"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPreventSelfReview", GoMethod: "ResetPreventSelfReview"},
