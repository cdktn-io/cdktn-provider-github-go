...
func (j *jsiiProxy_RepositoryEnvironmentReviewersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRepositoryEnvironmentReviewersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RepositoryEnvironmentReviewersList {
	_init_.Initialize()
...
func NewRepositoryEnvironmentReviewersList_Override(r RepositoryEnvironmentReviewersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RepositoryEnvironmentReviewersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RepositoryEnvironmentReviewersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RepositoryEnvironmentReviewersList) Resolve(context cdktn.IResolveContext) interface{} {
