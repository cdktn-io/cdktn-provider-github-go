...
func (r *jsiiProxy_RepositoryEnvironmentReviewersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RepositoryEnvironmentReviewersList) Resolve(context cdktf.IResolveContext) interface{} {
