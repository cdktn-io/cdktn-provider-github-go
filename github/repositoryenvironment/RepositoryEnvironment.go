...
func (j *jsiiProxy_RepositoryEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RepositoryEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RepositoryEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RepositoryEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RepositoryEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RepositoryEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RepositoryEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RepositoryEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RepositoryEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRepositoryEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RepositoryEnvironment) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RepositoryEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RepositoryEnvironment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RepositoryEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RepositoryEnvironment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RepositoryEnvironment) ToHclTerraform() interface{} {
	var returns interface{}
