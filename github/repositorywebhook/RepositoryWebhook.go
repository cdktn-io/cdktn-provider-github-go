...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/repository_webhook github_repository_webhook}.
...
func (j *jsiiProxy_RepositoryWebhook) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/repository_webhook github_repository_webhook} Resource.
func NewRepositoryWebhook(scope constructs.Construct, id *string, config *RepositoryWebhookConfig) RepositoryWebhook {
	_init_.Initialize()

	if err := validateNewRepositoryWebhookParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RepositoryWebhook)SetCount(val interface{}) {
...
func RepositoryWebhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRepositoryWebhook_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func RepositoryWebhook_IsConstruct(x interface{}) *bool {
	...
	if err := validateRepositoryWebhook_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func RepositoryWebhook_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateRepositoryWebhook_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func RepositoryWebhook_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateRepositoryWebhook_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RepositoryWebhook) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RepositoryWebhook) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RepositoryWebhook) ToHclTerraform() interface{} {
	var returns interface{}
