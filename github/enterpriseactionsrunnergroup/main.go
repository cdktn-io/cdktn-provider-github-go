...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EnterpriseActionsRunnerGroup)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSelectedOrganizationIds", GoMethod: "ResetSelectedOrganizationIds"},
			...
			_jsii_.MemberProperty{JsiiProperty: "selectedOrganizationIds", GoGetter: "SelectedOrganizationIds"},
			_jsii_.MemberProperty{JsiiProperty: "selectedOrganizationIdsInput", GoGetter: "SelectedOrganizationIdsInput"},
			_jsii_.MemberProperty{JsiiProperty: "selectedOrganizationsUrl", GoGetter: "SelectedOrganizationsUrl"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.enterpriseActionsRunnerGroup.EnterpriseActionsRunnerGroupConfig",
		reflect.TypeOf((*EnterpriseActionsRunnerGroupConfig)(nil)).Elem(),
	)
}
