...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/usergpgkey/internal"
...
type UserGpgKey interface {
	...
	SetArmoredPublicKey(val *string)
	ArmoredPublicKeyInput() *string
	// Experimental.
...
func (j *jsiiProxy_UserGpgKey) ArmoredPublicKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"armoredPublicKey",
...
func (j *jsiiProxy_UserGpgKey) ArmoredPublicKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"armoredPublicKeyInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_UserGpgKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_UserGpgKey) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_UserGpgKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_UserGpgKey) KeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyId",
...
func (j *jsiiProxy_UserGpgKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserGpgKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_UserGpgKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/user_gpg_key github_user_gpg_key} Resource.
...
func (j *jsiiProxy_UserGpgKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_UserGpgKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_UserGpgKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func UserGpgKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (u *jsiiProxy_UserGpgKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserGpgKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (u *jsiiProxy_UserGpgKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
