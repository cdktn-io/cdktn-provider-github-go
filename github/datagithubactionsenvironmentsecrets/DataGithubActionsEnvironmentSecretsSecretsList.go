...
func (d *jsiiProxy_DataGithubActionsEnvironmentSecretsSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubActionsEnvironmentSecretsSecretsList) Resolve(context cdktf.IResolveContext) interface{} {
