...
func (d *jsiiProxy_DataGithubRepositoryBranchesBranchesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubRepositoryBranchesBranchesList) Resolve(context cdktf.IResolveContext) interface{} {
