...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "onlyNonProtectedBranches", GoGetter: "OnlyNonProtectedBranches"},
			_jsii_.MemberProperty{JsiiProperty: "onlyNonProtectedBranchesInput", GoGetter: "OnlyNonProtectedBranchesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOnlyNonProtectedBranches", GoMethod: "ResetOnlyNonProtectedBranches"},
