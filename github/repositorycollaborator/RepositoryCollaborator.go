...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/repository_collaborator github_repository_collaborator}.
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/repository_collaborator github_repository_collaborator} Resource.
...
func RepositoryCollaborator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
