...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/repositorycollaborator/internal"
...
func (j *jsiiProxy_RepositoryCollaborator) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RepositoryCollaborator) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RepositoryCollaborator) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RepositoryCollaborator) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RepositoryCollaborator) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_collaborator github_repository_collaborator} Resource.
func NewRepositoryCollaborator(scope constructs.Construct, id *string, config *RepositoryCollaboratorConfig) RepositoryCollaborator {
	...
	if err := validateNewRepositoryCollaboratorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RepositoryCollaborator)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RepositoryCollaborator)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RepositoryCollaborator)SetPermissionDiffSuppression(val interface{}) {
	if err := j.validateSetPermissionDiffSuppressionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RepositoryCollaborator)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RepositoryCollaborator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRepositoryCollaborator_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func RepositoryCollaborator_IsConstruct(x interface{}) *bool {
	...
	if err := validateRepositoryCollaborator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RepositoryCollaborator) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RepositoryCollaborator) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RepositoryCollaborator) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RepositoryCollaborator) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RepositoryCollaborator) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RepositoryCollaborator) ToHclTerraform() interface{} {
	var returns interface{}
