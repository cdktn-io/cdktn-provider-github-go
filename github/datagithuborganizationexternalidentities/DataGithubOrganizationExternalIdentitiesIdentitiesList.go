...
func (d *jsiiProxy_DataGithubOrganizationExternalIdentitiesIdentitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubOrganizationExternalIdentitiesIdentitiesList) Resolve(context cdktf.IResolveContext) interface{} {
