...
func (j *jsiiProxy_DataGithubOrganizationExternalIdentitiesIdentitiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubOrganizationExternalIdentitiesIdentitiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubOrganizationExternalIdentitiesIdentitiesList {
	_init_.Initialize()
...
func NewDataGithubOrganizationExternalIdentitiesIdentitiesList_Override(d DataGithubOrganizationExternalIdentitiesIdentitiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubOrganizationExternalIdentitiesIdentitiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubOrganizationExternalIdentitiesIdentitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubOrganizationExternalIdentitiesIdentitiesList) Resolve(context cdktn.IResolveContext) interface{} {
