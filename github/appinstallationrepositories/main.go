...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "selectedRepositories", GoGetter: "SelectedRepositories"},
			_jsii_.MemberProperty{JsiiProperty: "selectedRepositoriesInput", GoGetter: "SelectedRepositoriesInput"},
