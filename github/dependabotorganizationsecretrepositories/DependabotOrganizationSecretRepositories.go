...
func (j *jsiiProxy_DependabotOrganizationSecretRepositories) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DependabotOrganizationSecretRepositories) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DependabotOrganizationSecretRepositories) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DependabotOrganizationSecretRepositories) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DependabotOrganizationSecretRepositories) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DependabotOrganizationSecretRepositories_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
