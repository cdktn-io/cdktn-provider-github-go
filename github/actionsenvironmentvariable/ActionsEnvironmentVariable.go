...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/actionsenvironmentvariable/internal"
...
func (j *jsiiProxy_ActionsEnvironmentVariable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ActionsEnvironmentVariable) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ActionsEnvironmentVariable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ActionsEnvironmentVariable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ActionsEnvironmentVariable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ActionsEnvironmentVariable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/actions_environment_variable github_actions_environment_variable} Resource.
...
func (j *jsiiProxy_ActionsEnvironmentVariable)SetCount(val interface{}) {
...
func (j *jsiiProxy_ActionsEnvironmentVariable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ActionsEnvironmentVariable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ActionsEnvironmentVariable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ActionsEnvironmentVariable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateActionsEnvironmentVariable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ActionsEnvironmentVariable) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ActionsEnvironmentVariable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActionsEnvironmentVariable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ActionsEnvironmentVariable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActionsEnvironmentVariable) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ActionsEnvironmentVariable) ToHclTerraform() interface{} {
	var returns interface{}
