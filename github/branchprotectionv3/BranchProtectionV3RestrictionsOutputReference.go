...
func (b *jsiiProxy_BranchProtectionV3RestrictionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BranchProtectionV3RestrictionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
