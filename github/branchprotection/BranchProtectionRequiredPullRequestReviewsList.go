...
func (j *jsiiProxy_BranchProtectionRequiredPullRequestReviewsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBranchProtectionRequiredPullRequestReviewsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BranchProtectionRequiredPullRequestReviewsList {
	_init_.Initialize()
...
func NewBranchProtectionRequiredPullRequestReviewsList_Override(b BranchProtectionRequiredPullRequestReviewsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BranchProtectionRequiredPullRequestReviewsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BranchProtectionRequiredPullRequestReviewsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BranchProtectionRequiredPullRequestReviewsList) Resolve(context cdktn.IResolveContext) interface{} {
