...
func (b *jsiiProxy_BranchProtectionRequiredPullRequestReviewsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BranchProtectionRequiredPullRequestReviewsList) Resolve(context cdktf.IResolveContext) interface{} {
