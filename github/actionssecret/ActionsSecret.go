...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v15/actionssecret/internal"
...
func (j *jsiiProxy_ActionsSecret) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ActionsSecret) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ActionsSecret) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ActionsSecret) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ActionsSecret)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ActionsSecret)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ActionsSecret)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ActionsSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ActionsSecret) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ActionsSecret) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ActionsSecret) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
