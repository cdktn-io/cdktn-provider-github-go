...
func (j *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubOrganizationIpAllowListIpAllowListStructList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubOrganizationIpAllowListIpAllowListStructList {
	_init_.Initialize()
...
func NewDataGithubOrganizationIpAllowListIpAllowListStructList_Override(d DataGithubOrganizationIpAllowListIpAllowListStructList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructList) Resolve(context cdktn.IResolveContext) interface{} {
