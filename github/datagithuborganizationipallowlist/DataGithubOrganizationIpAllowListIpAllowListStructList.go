...
func (d *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructList) Resolve(context cdktf.IResolveContext) interface{} {
