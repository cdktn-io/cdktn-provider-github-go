...
func (d *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (d *jsiiProxy_DataGithubOrganizationIpAllowListIpAllowListStructOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
