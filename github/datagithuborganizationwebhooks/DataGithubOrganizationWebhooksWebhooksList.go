...
func (j *jsiiProxy_DataGithubOrganizationWebhooksWebhooksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubOrganizationWebhooksWebhooksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubOrganizationWebhooksWebhooksList {
	_init_.Initialize()
...
func NewDataGithubOrganizationWebhooksWebhooksList_Override(d DataGithubOrganizationWebhooksWebhooksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubOrganizationWebhooksWebhooksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubOrganizationWebhooksWebhooksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubOrganizationWebhooksWebhooksList) Resolve(context cdktn.IResolveContext) interface{} {
