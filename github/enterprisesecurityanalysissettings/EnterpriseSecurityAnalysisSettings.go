...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/enterprisesecurityanalysissettings/internal"
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/enterprise_security_analysis_settings github_enterprise_security_analysis_settings} Resource.
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EnterpriseSecurityAnalysisSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EnterpriseSecurityAnalysisSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EnterpriseSecurityAnalysisSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EnterpriseSecurityAnalysisSettings) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EnterpriseSecurityAnalysisSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
