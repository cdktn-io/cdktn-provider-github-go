...
func (j *jsiiProxy_DataGithubActionsOrganizationVariablesVariablesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubActionsOrganizationVariablesVariablesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubActionsOrganizationVariablesVariablesList {
	_init_.Initialize()
...
func NewDataGithubActionsOrganizationVariablesVariablesList_Override(d DataGithubActionsOrganizationVariablesVariablesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubActionsOrganizationVariablesVariablesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubActionsOrganizationVariablesVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubActionsOrganizationVariablesVariablesList) Resolve(context cdktn.IResolveContext) interface{} {
