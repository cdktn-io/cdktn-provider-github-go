...
func (d *jsiiProxy_DataGithubActionsOrganizationVariablesVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubActionsOrganizationVariablesVariablesList) Resolve(context cdktf.IResolveContext) interface{} {
