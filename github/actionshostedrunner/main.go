...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "imageGen", GoGetter: "ImageGen"},
			_jsii_.MemberProperty{JsiiProperty: "imageGenInput", GoGetter: "ImageGenInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "lastActiveOn", GoGetter: "LastActiveOn"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "machineSizeDetails", GoGetter: "MachineSizeDetails"},
			_jsii_.MemberProperty{JsiiProperty: "maximumRunners", GoGetter: "MaximumRunners"},
			_jsii_.MemberProperty{JsiiProperty: "maximumRunnersInput", GoGetter: "MaximumRunnersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImageGen", GoMethod: "ResetImageGen"},
			_jsii_.MemberMethod{JsiiMethod: "resetImageVersion", GoMethod: "ResetImageVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumRunners", GoMethod: "ResetMaximumRunners"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublicIpEnabled", GoMethod: "ResetPublicIpEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "runnerGroupId", GoGetter: "RunnerGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "runnerGroupIdInput", GoGetter: "RunnerGroupIdInput"},
