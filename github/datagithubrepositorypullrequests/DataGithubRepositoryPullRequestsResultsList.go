...
func (j *jsiiProxy_DataGithubRepositoryPullRequestsResultsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubRepositoryPullRequestsResultsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubRepositoryPullRequestsResultsList {
	_init_.Initialize()
...
func NewDataGithubRepositoryPullRequestsResultsList_Override(d DataGithubRepositoryPullRequestsResultsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubRepositoryPullRequestsResultsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsList) Resolve(context cdktn.IResolveContext) interface{} {
