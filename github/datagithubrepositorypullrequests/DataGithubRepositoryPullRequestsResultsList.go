...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsList) Resolve(context cdktf.IResolveContext) interface{} {
