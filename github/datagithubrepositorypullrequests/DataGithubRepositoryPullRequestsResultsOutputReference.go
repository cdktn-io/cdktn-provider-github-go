...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/datagithubrepositorypullrequests/internal"
...
type DataGithubRepositoryPullRequestsResultsOutputReference interface {
	...
	Labels() *[]*string
	MaintainerCanModify() cdktn.IResolvable
	Number() *float64
	OpenedAt() *float64
	OpenedBy() *string
	State() *string
...
func (j *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) Draft() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) MaintainerCanModify() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"maintainerCanModify",
...
func (j *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubRepositoryPullRequestsResultsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGithubRepositoryPullRequestsResultsOutputReference {
	_init_.Initialize()
...
func NewDataGithubRepositoryPullRequestsResultsOutputReference_Override(d DataGithubRepositoryPullRequestsResultsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubRepositoryPullRequestsResultsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
