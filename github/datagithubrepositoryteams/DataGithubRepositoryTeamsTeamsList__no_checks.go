...
func (d *jsiiProxy_DataGithubRepositoryTeamsTeamsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGithubRepositoryTeamsTeamsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGithubRepositoryTeamsTeamsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGithubRepositoryTeamsTeamsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
