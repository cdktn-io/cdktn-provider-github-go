...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/organization_settings github_organization_settings}.
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.0/docs/resources/organization_settings github_organization_settings} Resource.
...
func OrganizationSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
