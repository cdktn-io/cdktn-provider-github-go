...
func (j *jsiiProxy_RepositoryRulesetBypassActorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRepositoryRulesetBypassActorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RepositoryRulesetBypassActorsList {
	_init_.Initialize()
...
func NewRepositoryRulesetBypassActorsList_Override(r RepositoryRulesetBypassActorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RepositoryRulesetBypassActorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RepositoryRulesetBypassActorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RepositoryRulesetBypassActorsList) Resolve(context cdktn.IResolveContext) interface{} {
