...
func (r *jsiiProxy_RepositoryRulesetBypassActorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RepositoryRulesetBypassActorsList) Resolve(context cdktf.IResolveContext) interface{} {
