...
type RepositoryRulesetRulesPullRequest struct {
	...
	AllowedMergeMethods *[]*string `field:"optional" json:"allowedMergeMethods" yaml:"allowedMergeMethods"`
	...
	RequiredReviewers interface{} `field:"optional" json:"requiredReviewers" yaml:"requiredReviewers"`
