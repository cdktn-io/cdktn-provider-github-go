...
func (j *jsiiProxy_RepositoryRulesetRulesRequiredStatusChecksRequiredCheckList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewRepositoryRulesetRulesRequiredStatusChecksRequiredCheckListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
