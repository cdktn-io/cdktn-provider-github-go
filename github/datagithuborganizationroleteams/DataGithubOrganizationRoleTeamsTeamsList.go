...
func (j *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDataGithubOrganizationRoleTeamsTeamsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubOrganizationRoleTeamsTeamsList {
	...
	j := jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList{}
...
func (j *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList) Get(index *float64) DataGithubOrganizationRoleTeamsTeamsOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataGithubOrganizationRoleTeamsTeamsOutputReference
...
func (d *jsiiProxy_DataGithubOrganizationRoleTeamsTeamsList) ToString() *string {
	var returns *string
