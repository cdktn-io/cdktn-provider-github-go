...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/datagithubactionsorganizationregistrationtoken/internal"
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataGithubActionsOrganizationRegistrationToken(scope constructs.Construct, id *string, config *DataGithubActionsOrganizationRegistrationTokenConfig) DataGithubActionsOrganizationRegistrationToken {
	...
	_jsii_.Create(
		"@cdktn/provider-github.dataGithubActionsOrganizationRegistrationToken.DataGithubActionsOrganizationRegistrationToken",
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataGithubActionsOrganizationRegistrationToken resource upon running "cdktn plan <stack-name>".
func DataGithubActionsOrganizationRegistrationToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataGithubActionsOrganizationRegistrationToken_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) ToHclTerraform() interface{} {
	var returns interface{}
