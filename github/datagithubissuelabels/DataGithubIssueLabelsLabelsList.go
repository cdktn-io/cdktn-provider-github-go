...
func (d *jsiiProxy_DataGithubIssueLabelsLabelsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubIssueLabelsLabelsList) Resolve(context cdktf.IResolveContext) interface{} {
