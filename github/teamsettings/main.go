...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putReviewRequestDelegation", GoMethod: "PutReviewRequestDelegation"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetReviewRequestDelegation", GoMethod: "ResetReviewRequestDelegation"},
			_jsii_.MemberProperty{JsiiProperty: "reviewRequestDelegation", GoGetter: "ReviewRequestDelegation"},
			_jsii_.MemberProperty{JsiiProperty: "reviewRequestDelegationInput", GoGetter: "ReviewRequestDelegationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "teamUid", GoGetter: "TeamUid"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "memberCountInput", GoGetter: "MemberCountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMemberCount", GoMethod: "ResetMemberCount"},
