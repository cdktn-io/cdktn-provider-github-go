...
func (t *jsiiProxy_TeamSettingsReviewRequestDelegationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TeamSettingsReviewRequestDelegationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
