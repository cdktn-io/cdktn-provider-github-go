...
func (j *jsiiProxy_EnterpriseActionsPermissions) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EnterpriseActionsPermissions) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EnterpriseActionsPermissions) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EnterpriseActionsPermissions) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EnterpriseActionsPermissions) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/enterprise_actions_permissions github_enterprise_actions_permissions} Resource.
...
func (j *jsiiProxy_EnterpriseActionsPermissions)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EnterpriseActionsPermissions)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EnterpriseActionsPermissions)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EnterpriseActionsPermissions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EnterpriseActionsPermissions) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EnterpriseActionsPermissions) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EnterpriseActionsPermissions) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
