...
// Represents a {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/organization_teams github_organization_teams}.
...
func (j *jsiiProxy_DataGithubOrganizationTeams) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGithubOrganizationTeams) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGithubOrganizationTeams) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGithubOrganizationTeams) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGithubOrganizationTeams) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/organization_teams github_organization_teams} Data Source.
...
func (j *jsiiProxy_DataGithubOrganizationTeams)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGithubOrganizationTeams)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGithubOrganizationTeams)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DataGithubOrganizationTeams resource upon running "cdktn plan <stack-name>".
func DataGithubOrganizationTeams_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGithubOrganizationTeams) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubOrganizationTeams) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
