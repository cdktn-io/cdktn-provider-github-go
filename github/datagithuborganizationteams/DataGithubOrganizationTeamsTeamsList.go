...
func (j *jsiiProxy_DataGithubOrganizationTeamsTeamsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubOrganizationTeamsTeamsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubOrganizationTeamsTeamsList {
	_init_.Initialize()
...
func NewDataGithubOrganizationTeamsTeamsList_Override(d DataGithubOrganizationTeamsTeamsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubOrganizationTeamsTeamsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubOrganizationTeamsTeamsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubOrganizationTeamsTeamsList) Resolve(context cdktn.IResolveContext) interface{} {
