...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/datagithubipranges/internal"
...
func (j *jsiiProxy_DataGithubIpRanges) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGithubIpRanges) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGithubIpRanges) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGithubIpRanges) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGithubIpRanges) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/ip_ranges github_ip_ranges} Data Source.
...
func (j *jsiiProxy_DataGithubIpRanges)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGithubIpRanges)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGithubIpRanges)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGithubIpRanges_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGithubIpRanges) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGithubIpRanges) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
