...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGithubReleaseAsset)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "downloadFileContents", GoGetter: "DownloadFileContents"},
			_jsii_.MemberProperty{JsiiProperty: "downloadFileContentsInput", GoGetter: "DownloadFileContentsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fileContents", GoGetter: "FileContents"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDownloadFileContents", GoMethod: "ResetDownloadFileContents"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-github.dataGithubReleaseAsset.DataGithubReleaseAssetConfig",
		reflect.TypeOf((*DataGithubReleaseAssetConfig)(nil)).Elem(),
	)
}
