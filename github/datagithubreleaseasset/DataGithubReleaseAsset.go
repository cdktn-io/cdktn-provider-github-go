...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v15/datagithubreleaseasset/internal"
...
func (j *jsiiProxy_DataGithubReleaseAsset) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataGithubReleaseAsset) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataGithubReleaseAsset) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGithubReleaseAsset) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataGithubReleaseAsset) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGithubReleaseAsset)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGithubReleaseAsset)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGithubReleaseAsset)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGithubReleaseAsset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGithubReleaseAsset) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGithubReleaseAsset) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
