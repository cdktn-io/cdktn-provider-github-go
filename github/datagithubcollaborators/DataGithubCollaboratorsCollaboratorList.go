...
func (d *jsiiProxy_DataGithubCollaboratorsCollaboratorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubCollaboratorsCollaboratorList) Resolve(context cdktf.IResolveContext) interface{} {
