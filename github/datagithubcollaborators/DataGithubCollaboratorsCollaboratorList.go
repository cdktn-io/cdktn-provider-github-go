...
func (j *jsiiProxy_DataGithubCollaboratorsCollaboratorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGithubCollaboratorsCollaboratorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGithubCollaboratorsCollaboratorList {
	_init_.Initialize()
...
func NewDataGithubCollaboratorsCollaboratorList_Override(d DataGithubCollaboratorsCollaboratorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGithubCollaboratorsCollaboratorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGithubCollaboratorsCollaboratorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGithubCollaboratorsCollaboratorList) Resolve(context cdktn.IResolveContext) interface{} {
