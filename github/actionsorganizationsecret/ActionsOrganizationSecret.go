...
import (
	...
	"github.com/cdktn-io/cdktn-provider-github-go/github/v16/actionsorganizationsecret/internal"
...
func (j *jsiiProxy_ActionsOrganizationSecret) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ActionsOrganizationSecret) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ActionsOrganizationSecret) KeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyId",
...
func (j *jsiiProxy_ActionsOrganizationSecret) KeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyIdInput",
...
func (j *jsiiProxy_ActionsOrganizationSecret) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ActionsOrganizationSecret) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ActionsOrganizationSecret) RemoteUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"remoteUpdatedAt",
...
func (j *jsiiProxy_ActionsOrganizationSecret) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/actions_organization_secret github_actions_organization_secret} Resource.
...
func (j *jsiiProxy_ActionsOrganizationSecret)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ActionsOrganizationSecret)SetKeyId(val *string) {
...
func (j *jsiiProxy_ActionsOrganizationSecret)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ActionsOrganizationSecret)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ActionsOrganizationSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ActionsOrganizationSecret) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActionsOrganizationSecret) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ActionsOrganizationSecret) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActionsOrganizationSecret) ResetKeyId() {
	_jsii_.InvokeVoid(
		a,
		"resetKeyId",
		nil, // no parameters
