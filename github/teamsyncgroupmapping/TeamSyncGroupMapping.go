...
func (j *jsiiProxy_TeamSyncGroupMapping) Connection() interface{} {
...
func (j *jsiiProxy_TeamSyncGroupMapping) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_TeamSyncGroupMapping) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TeamSyncGroupMapping) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_TeamSyncGroupMapping) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TeamSyncGroupMapping) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TeamSyncGroupMapping) Group() TeamSyncGroupMappingGroupList {
	var returns TeamSyncGroupMappingGroupList
	_jsii_.Get(
		j,
		"group",
		&returns,
...
func (j *jsiiProxy_TeamSyncGroupMapping) GroupInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"groupInput",
...
func (j *jsiiProxy_TeamSyncGroupMapping) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TeamSyncGroupMapping) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_TeamSyncGroupMapping) Node() constructs.Node {
...
func (j *jsiiProxy_TeamSyncGroupMapping) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_TeamSyncGroupMapping) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_TeamSyncGroupMapping) TeamSlug() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamSlug",
...
func (j *jsiiProxy_TeamSyncGroupMapping) TeamSlugInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamSlugInput",
...
func (j *jsiiProxy_TeamSyncGroupMapping) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TeamSyncGroupMapping) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/team_sync_group_mapping github_team_sync_group_mapping} Resource.
...
// Experimental.
func TeamSyncGroupMapping_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTeamSyncGroupMapping_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TeamSyncGroupMapping_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTeamSyncGroupMapping_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func TeamSyncGroupMapping_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-github.teamSyncGroupMapping.TeamSyncGroupMapping",
...
func (t *jsiiProxy_TeamSyncGroupMapping) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TeamSyncGroupMapping) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TeamSyncGroupMapping) MoveFromId(id *string) {
...
func (t *jsiiProxy_TeamSyncGroupMapping) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TeamSyncGroupMapping) MoveToId(id *string) {
...
func (t *jsiiProxy_TeamSyncGroupMapping) ResetGroup() {
	_jsii_.InvokeVoid(
		t,
		"resetGroup",
		nil, // no parameters
...
func (t *jsiiProxy_TeamSyncGroupMapping) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_TeamSyncGroupMapping) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TeamSyncGroupMapping) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TeamSyncGroupMapping) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TeamSyncGroupMapping) ToHclTerraform() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TeamSyncGroupMapping) ToMetadata() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TeamSyncGroupMapping) ToString() *string {
	var returns *string
...
func (t *jsiiProxy_TeamSyncGroupMapping) ToTerraform() interface{} {
	var returns interface{}
